...
from config.paths_config import ENGINEERED_DATA_PATH
    ...
    def train_and_evaluate(self, X_train, X_test, y_train, y_test):
        try:
            ...
            for idx, (name, model) in enumerate(self.models.items()):
                ...
                logger.info(f"{name} trained successfully. Metrics: Accuracy: {accuracy}, Precision: {precision}, Recall: {recall}, F1 Score: {f1}")
                ...
                self.writer.add_text('Model Details', f"Name: {name}, Metrics: Accuracy: {accuracy}, Precision: {precision}, Recall: {recall}, F1 Score: {f1}")
