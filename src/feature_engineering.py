...
from utils.helpers import label_encode  # Assuming this is already in helpers.py
...
class FeatureEngineer:
    def __init__(self):
        ...
        self.df = None
        self.label_mappings = {}  # To store label mappings for future reference
    ...
    def feature_construction(self):
        try:
            ...
            # Creating a feature representing total guests
    ...
    def handle_reservation_status_date(self):
        try:
            ...
            # Extract year, month, and day from 'reservation_status_date'
    ...
    def feature_selection(self):
        try:
            ...
            # Note: All features are retained; mutual information scores are for analysis purposes only
        except Exception as e:
    ...
    def run(self):
        try:
            ...
            self.handle_reservation_status_date()  # Add handling for 'reservation_status_date'
